...
; Only Make Changes under this

; Change this to change how much the vol goes up
vol_Step = 4

; How long to display The volume bars. this time in is milisecounds 
vol_DisplayTime = 2000

; Master Volume Bar color (see the help file to find all the diffrent colors)
vol_CBM = Cyan
...
; Bar's screen position.  (-1 = center)
vol_PosX = -1
vol_PosY = -1
...
;__________Execute Section__________________ 
