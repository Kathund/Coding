Menu, TRAY, Icon, C:\Users\crbra\OneDrive\Desktop\Not School\coding\ICONS\open-app.ico
...
start:
    InputBox, APP, Start, What App Do You Want To Run?, , , , , , , 45
        If (APP = "edit")
            Goto, edit
        If (APP = "gui")
            Run, C:\Users\crbra\OneDrive\Desktop\Not School\coding\Autohotkey\OPEN-APP-GUI.ahk
        If (APP = "stop")
            ExitApp
        If (APP = "vs")
            Goto, VS
...
VS:
        InputBox, VS, VS, What Part Of VS Do You Want To Open?, , , , , , , 45
        If (VS = "HTML")
            {
                MsgBox, 0, VS, HTML will now start!, 0.75
                Run, C:\Users\crbra\OneDrive\Desktop\Not School\coding\Visual Studio code\Workspace\HTML code.code-workspace
                MsgBox, 0, VS HTML Has started!, 1.25
                Return
            }
        If (VS = "Workspace")
            {
                InputBox, WorkSpace, What Workspace do you want to open?, , , , , , , 45
                If (WorkSpace = "defualt")
                MsgBox, 0, VS, DEFUALT workspace will now open., 0.75
                Run, C:\Users\crbra\OneDrive\Desktop\Not School\coding\Visual Studio code\Workspace\OPEN app workspace.code-workspace
                SLeep, 750
                MsgBox, 0, VS, DEFUALT Workspace has now opened!, 1.25
...
xANDy:
    {
        MsgBox, 0,  Start, Your x and y mouse cords will be on the top left, 0.75
        SplashTextOn, 500, 100, X and Y, 3
        WinMove, X and Y, , 0, 0
        Sleep, 1000
        SplashTextOff
        SplashTextOn, 500, 100, X and Y, 2
        WinMove, X and Y, , 0, 0
        Sleep, 1000x
        SplashTextOff
        SplashTextOn, 500, 100, X and Y, 1
        WinMove, X and Y, , 0, 0
        Sleep, 1000
        SplashTextOff
        SplashTextOn, 500, 100, X and Y, 0
        WinMove, X and Y, , 0, 0
        Sleep, 1000
        SplashTextOff
        MouseGetPos, xpos, ypos 
        SplashTextOn, 500, 100, X and Y, The cursor is at X%xpos% Y%ypos%.
        WinMove, X and Y, , 0, 0
        Sleep, 10000
        MsgBox, 0, X and Y, Click ok to close x and y, 
        IfMsgBox, OK
        SplashTextOff
        Return
    }
...
Timer:
    {
        MsgBox, 0,  Start, Class Timer Will Now Start!, 0.75
        Run, https://ict.kennedy.wa.edu.au/timers/Kennedy-periods-timer.html
        Sleep, 500
        MsgBox, 0, Start, Class timer Has started!, 1.25
        Return
    }
Return
...
Look:
    {
        MsgBox, 0, Look Up, looking up %Clipboard%, 1.75
        Msgbox, 0, Look Up, Found %Clipboard%! Opening it up, 1.5
        Sleep, 750
        Run, http://www.google.com/search?q=%clipboard%
        Sleep, 1750
        MsgBox, 0, Look Up, Opened look Up, 1.25
        Return
    }
Return
...
Edit:
    {
        MsgBox, 0, Start, This SCRIPT (Visual Studio code) will now start!, 0.75
        Run, C:\Users\crbra\OneDrive\Desktop\Not School\coding\Visual Studio code\Workspace\OPEN app workspace.code-workspace
        Sleep, 2500
        MsgBox, 0, Start, THIS SCRIPT (Visual Studio Code) Has started!, 1.25
        Return
    }
Return
...
Teams:
    {
        MsgBox, 0, Start, Teams Will Now Load!, 0.75
        Run, C:\Users\crbra\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Microsoft Teams.lnk
        Sleep, 2500
        MsgBox, 0, Start, Teams Has Loaded!, 1.25
        Return
    }
Return
...
Reload: 
    {
        MsgBox, 0, Start, This will now reload!, 0.75
        Reload
        Sleep 1000 ; If successful, the reload will close this instance during the Sleep, so the line below will never be reached.
        MsgBox,  2 ,, The script could not be reloaded. Would you like to open it for editing?
        IfMsgBox, Yes, Goto, Edit
...
Cal:
{
    MsgBox, 0, Start, Calculator WIll Now load!, 0.75
    Sleep, 750 ; 26
Help_text=
(
...
Clipboard:
    {
    SplashTextOn, 400, 600, Clipboard, The clipboard contains:`n%clipboard%
    WinMove, Clipboard, , 0, 0  ; Move the splash window to the top left corner.
    MsgBox, 0, CLIPBOARD, Press OK to dismiss the Clipboard
    SplashTextOff
    }
Return
...
Seqta:
    {
        MsgBox, 0, Start, Seqta will now load!, 0.75
        Run, https://student.kennedy.wa.edu.au/#?page=/welcome
        Sleep, 2500
        MsgBox, 0, Start, Seqta has been started, 1.25
        Return
    }
Return

Timetable: ;code is gamer girl
    {
    MsgBox, 0, Start, Seqta timetable will now load!, 0.75
    Run, https://student.kennedy.wa.edu.au/#?page=/timetable
    Sleep, 2500
    MsgBox, 0, Start, Seqta timetable has been started, 1.25
    Return
    }
Return

Science:
    InputBox, Science, Science, What Part Of Science Do You Want To Run?, , , , , , , 45F
        If ()
       If (Science = "stop")
            Exit,
        if ( Science = "Teams")
        {
                MsgBox, 0, Science, Science Teams will now load!, 0.75
                Run, C:\Users\crbra\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Microsoft Teams.lnk
                Sleep, 28500
                MouseClick, left, 260, 145, 1, 0,
                Sleep, 750
                MouseClick, left, 480, 480, 1, 0,
                MsgBox, 0, Science, Science teams has loaded!, 1.25
                Return
        }
        Return
        if (Science = "powerpoint")
         {
             MsgBox, 0, SCIENCE, Science PowerPoint will now load!, 0.75
             Run, C:\Users\crbra\OneDrive\Desktop\School\subjects\Science\Topic 1 Cell.ppt
             Sleep  , 2500
             MsgBox, 0, SCIENCE, Science PowerPoint has Loaded!, 1.25
             Return
         }
        If (Science = "seqta")
        {    
            MsgBox, 0, Science, Science Seqta will now load!, 0.75
            Run, https://student.kennedy.wa.edu.au/#?page=/courses/4627:21820
            Sleep, 2500
            MsgBox, 0, SCIENCE, Science Seqta has loaded!, 1.25
            Return
        }
        if (Science = "Onenote")
        {
            MsgBox, 0, Science, Science onenote has loaded!, 1.25
            Send, {LWin}
            Sleep, 750
            ...
            Send, {Enter}
            Sleep, 1750
            MouseClick, left, 360, 250, 1, 0,
            Sleep, 750
            MouseClick, left, 270, 410, 1, 0,
            MsgBox, 0, Science, Science onenote has loaded!, 1.25
            Return
        }
        if (Science = "book")
        {
            MsgBox, 0, Science Start, Your Science Book Will Now Open!, 0.75
            Run, C:\Users\crbra\OneDrive\Desktop\School\subjects\Science\Science_book.pdf
            Sleep, 2500
            MsgBox, 0, Science, Your book has started, 1.25
            Return
        }
Return
...
Math:
    InputBox, Math, Math, What Part Of Math Do You Want To Run?, , , , , , , 45
    If (Math = "stop")
        Exit,
    If (Math = "onenote")
    {
        MsgBox, 0, Math, Math Onenote Will now load!, 0.75
        Send, {LWin}
        Sleep, 750
        Send, onenote for windows 10
        Sleep, 750
        ...
        MouseClick, left, 360, 250, 1, 0,
        Sleep, 750
        MouseClick, left, 390, 330, 1, 0,
        MsgBox, 0, Math, Math onenote has loaded!, 1.25
        Return
    }    
    if (Math = "textbook")
    {
        MsgBox, 0, Math, Math Text Book Will Now Load!, 0.75
        Run, https://webdav.kennedy.wa.edu.au/
        Sleep, 2500
        Send, {Enter}
        Sleep, 750
        ...
        MouseClick, Left, 500, 600, 1, 0
        Sleep, 750
        MouseClick, left, 600, 480, 1, 0
        Sleep, 750
            InputBox, Chapter, Math, What Chapter do you want to go to?, , , , , , , 15
            If (Chapter = "Answers")
            {
                MouseClick, left, 600, 540, 1, 0,
                Return
            }
            If (Chapter = "1")
            {
                MouseClick, left, 600, 570, 1, 0
                Return
            }
            If (Chapter = "2")
            {
                MouseClick, left, 600, 610, 1, 0
                Return
            }
            If (Chapter = "3")
            {
                MouseClick, left, 600, 660, 1, 0,
                Return
            }
            If (Chapter = "4")
            {
            ...
            If (Chapter = "5")
            {
                MouseClick, left, 600, 730, 1, 0,
                Return
            }
            If (Chapter = "6")
            {
                MouseClick, left, 600, 760, 1, 0,
                Return
            }
            If (Chapter = "7")
            {
                MouseClick, left, 600, 790, 1, 0, 
                Return
            }
            If (Chapter = "8")
            {
                MouseClick, left, 600, 820, 1, 0,
                Return
            }
            If (Chapter = "9")
            {
                MouseClick, left, 600, 850, 1, 0,
                Return
            }
            If (Chapter = "10")
            {
    ...
    If (Math = "seqta")
    {
        MsgBox, 0, Math, Math Seqta Will Now load!, 0.75
        Run, https://student.kennedy.wa.edu.au/#?page=/courses/4685:21793
        Sleep, 2500
        MsgBox, 0, Math, Math Seqta Has Loaded!, 1.25
        Return
    }
Return

Humanities:
    InputBox, Humanities, Humanities, What part of Humanities do you want to open!, , , , , , , 45
    if (Humanities = "Seqta")
    {
        MsgBox, 0, Humanities, Humanities Seqta will now load!, 0.75
        Run, https://student.kennedy.wa.edu.au/#?page=/courses/4936:21763
        Sleep, 2500
        MsgBox, 0, Humanities, Humanities Seqta Has loaded!, 1.25
        Return
    }
Return

Drama:
    InputBox, Drama, Drama, What Part Of Drama Do you want to open!, , , , , , , 45
    if (Drama = "Seqta")
    {
        MsgBox, 0, Drama, Drama Seqta will now load!, 0.75
        Run, https://student.kennedy.wa.edu.au/#?page=/courses/4767:21712
        Sleep, 2500
        MsgBox, 0, Drama, Drama Seqta Has loaded!, 1.25
        Return
    }
    if (Drama = "teams")
    {
        MsgBox, 0, Drama, Drama Teams will now load!, 0.75
        Run, C:\Users\crbra\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Microsoft Teams.lnk
        Sleep, 28500
        MouseClick, left, 260, 145, 1, 0,
        Sleep, 750
        MouseClick, left, 480, 480, 1, 0,
        MsgBox, 0, Drama, Drama teams has loaded!, 1.25
        Return
    }
    if (Drama = "Onenote")
    {
        MsgBox, 0, Drama, Drama Onenote Will Now LOad!, 0.75
        Send, {LWin}
        Sleep, 750
        Send, onenote for windows 10
        Sleep, 750
        ...
        MouseClick, left, 360, 250, 1, 0,
        Sleep, 750
        MouseClick, left, 400, 640, 1, 0,
        MsgBox, 0, Drama, Drama onenote has loaded!, 1.25
        Return
    }
Return
...
Hdrive:
    {
    MsgBox, 0, Start, H drive will now load!, 0.75
    Run, https://webdav.kennedy.wa.edu.au/
    Sleep, 2500
    Send, {Enter}
    Sleep, 750
    MouseClick, Left, 300, 480, 1, 0,
    Sleep, 1500
    Send, {Enter}
    Sleep, 750
    MouseClick, left, 500, 850, 1, 0, 
    Sleep, 750
    MouseClick, left, 550, 950, 1, 0, 
    Sleep, 750
    MsgBox, 0, Start, H Drive has been started, 1.25
    Return
    }
...
Ydrive:
    {
        MsgBox, 0, start, Y Drive will now load!, 0.75
        Run, \\curric.kennedy.wa.edu.au\student\YDrive\Allsubjects\Year8
        Sleep, 1500
        InputBox, YDRIVE, Y Drive, What Part Of Y Drive Do You Want To Open, , , , , , , 45
            If (YDRIVE = "computing")
                {
                    Send, {Down}{Enter}
                    Return
...
Color: 
    {
        SplashTextOn, 300, 50, Color picker will start in..., 3
        Sleep, 1000
        SplashTextOff
        SplashTextOn, 300, 50, Color picker will start in..., 2
        Sleep, 1000
        SplashTextOff
        SplashTextOn, 300, 50, Color picker will start in..., 1
        Sleep, 1000
        SplashTextOff
        Sleep, 1000
...
English:
    InputBox, English, English, What Part Of English Do You Want To Run?, , , , , , , 45
    If (English = "stop")
        Exit,
    if (English = "teams") 
        {
                MsgBox, 0, English, English Teams will now load!, 0.75
                Run, C:\Users\crbra\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Microsoft Teams.lnk
                Sleep, 28500
                MouseClick, left, 260, 145, 1, 0,
                Sleep, 750
                MouseClick, left, 1000, 500, 1, 0,
                MsgBox, 0, English, English teams has loaded!, 1.25
                Return
        }
    If (English = "Seqta")
    {
        MsgBox, 0, English, English Seqta will now load!, 0.75
        Run, https://student.kennedy.wa.edu.au/#?page=/courses/4953:21732
        Sleep, 2500
        MsgBox, 0, English, English Seqta has loaded!, 1.25
        Return
    }
    if (English = "document")
    {
        MsgBox, 0, English, English document will now load!, 0.75
        Run, C:\Users\crbra\OneDrive\Desktop\School\subjects\English\Week 2 and 3 Paragraph responses Year 8.docx
        Sleep, 2500
        MsgBox, 0, English, English document has been started, 1.25
        Return
    }
Return
